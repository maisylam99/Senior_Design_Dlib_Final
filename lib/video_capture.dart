...
class _VideoRecorderExampleState extends State<VideoRecorderExample> {
  ...
  void initState() {
    ...
    //Video Player Intialization
    _controller = VideoPlayerController.asset("assets/vertical_test.mov");
  ...
  Future<String> _startVideoRecording() async {
    ...
    final String videoDirectory = '${appDirectory.path}/captured_videos';
